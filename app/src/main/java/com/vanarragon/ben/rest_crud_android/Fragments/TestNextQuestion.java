...
public class TestNextQuestion extends Fragment{

    private TextView lblQuestionID, lblCategoryID, lblQuestionText, lblQuestionTypeID, lblCountdown;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_test_next_question, container, false);

        lblQuestionText = (TextView) v.findViewById(R.id.next_question_textview4);
        rg = (RadioGroup) v.findViewById(R.id.rgAnswers);
        lblCountdown = (TextView) v.findViewById(R.id.countdown);
                    ...
                    public void onClick(View v) {
                        ...
                        mHandler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                llp.gravity=(Gravity.RIGHT | Gravity.CENTER_VERTICAL); // llp.setMargins(left, top, right, bottom);
                                lblCountdown.setLayoutParams(llp);
    ...
    public void uploadResults() {
        ...
        String testWrittenDate = sdf.format(nowDate);

        System.out.println(correctAnswersCounter);
        System.out.println(Base.userID);
